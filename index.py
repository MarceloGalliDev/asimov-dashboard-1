...
from dash_bootstrap_templates import ThemeSwitchAIO # type: ignore
from app import *
...
top_publishers = top_publishers.sort_values(ascending=False).head(10).reset_index() # type: ignore
